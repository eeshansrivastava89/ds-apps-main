// Build Log Config - migrated from packages/build-log/src/data/build-log-config.js

import type { Category, Status } from './build-log-types'
...
export const PROJECT_METADATA: Record<string, { name: string; path: string }> = {
